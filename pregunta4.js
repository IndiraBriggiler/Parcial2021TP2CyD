...
function addDiscoveries(inventor, discoveries, inventors) {
  let inventorsWhitDiscoveries = [];
  let index = inventors.findIndex((i) => i.last === inventor);

  inventorsWhitDiscoveries.push(inventors[index]);

  inventorsWhitDiscoveries[index].discoveries = discoveries;

  return inventorsWhitDiscoveries;
}
